...
@Component({
  ...
  templateUrl: './list-candidacy1.component.html',
  styleUrls: ['./list-candidacy.component.scss']
})
export class ListCandidacy1Component implements OnInit {
  idCandidacy: number;
  candidacy: any;
  candidacies:any;
  POSTS: any;
 ...
 deleteCandidacy = (id: number) => {
  ...
  updateCandidatureStatus(id: number){
    this.router.navigate(['update3', id]);
  } 
